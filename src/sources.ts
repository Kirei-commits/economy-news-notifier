...
export const FEED_SOURCES: FeedSource[] = [
  ...
  { name: "ECB", url: "https://www.ecb.europa.eu/rss/press.html", category: "金融政策", english: true },
  ...
  { name: "東洋経済オンライン", url: "https://toyokeizai.net/list/feed/rss", category: "国内経済" },

  // 海外経済
  { name: "BBC Business", url: "https://feeds.bbci.co.uk/news/business/rss.xml", category: "海外経済", english: true },
  {
    name: "CNBC Economy",
